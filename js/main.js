const menuSections = {
  bread: [
    {
      ...
      weight: '550 г.',
      composition: 'мука ржаная цельнозерновая, солод, мука пш. 1 с., мука ржаная обдирная, экстракт солода ячменный, сахар, морская соль, кориандр.'
    },
    {
      imgClass: 'bread-43',
      name: 'Хлеб Бриошь',
      weight: '300 г.',
      composition: 'мука пш. 1 с., мука с высоким содержанием белка, куриное яйцо, сахар, сливочное масло, молоко.'
    },
    {
      imgClass: 'bread-42',
      name: 'Комбуча',
      weight: '375 г.',
      composition: 'комбуча, мука пш. 1 с., мука пш. цельнозерновая, оливковое масло, тмин, солод, морская соль.'
    },
    {
      imgClass: 'bread-41',
      name: 'Пшенично - ржаной тартин',
      weight: '440 г.',
      composition: 'вода, мука пш. в/с, мука ржаная цельнозерновая, мука пшеничная цельнозерновая, соль морская.'
    },
    {
      imgClass: 'bread-40',
      name: 'Шведский хлеб',
      weight: '280 г.',
      composition: 'вода, мука рж. сеяная, мука пш. 2 с., мука картофельная, солод, масло подсолн., патока, тмин, изюм, морская соль.'
    },
    {
      imgClass: 'bread-39',
      name: 'Турецкая лепешка рамазан пиде',
      weight: '680 г.',
      composition: 'вода, мука пш. в/с, мука пш. 1 с., молоко, оливковое масло, куриное яйцо, тростниковый сахар, морская соль.'
    },
    {
      imgClass: 'bread-38',
      name: 'Пита',
      weight: '95 г.',
      composition: 'вода, мука пш. цельнозерновая, молоко, сливочное масло, тростниковый сахар, морская соль.'
    },
    {
      imgClass: 'bread-37',
      name: 'Пшеничный Диетический',
      weight: '400 г.',
      composition: 'вода, мука пш. цельнозерновая, отруби пш., пш. зародышевые хлопья, морская соль.'
    },
    {
      imgClass: 'bread-36',
      name: 'Хала',
      weight: '400 г.',
      composition: 'вода, мука пш. цельнозерновая, молоко, масло подсолн., куриное яйцо, тростниковый сахар, мак, морская соль.'
    },
    {
      imgClass: 'bread-35',
      name: 'Деревенская булка',
      weight: '470 г.',
      composition: 'сыворотка, вода, мука пш. цельнозерновая, сливочное масло, куриное яйцо, кардамон, тростниковый сахар, морская соль.'
    },
    {
      imgClass: 'bread-34',
    ...
    },
    {
      ...
      name: 'Тыквенный хлеб',
      weight: '500 г.',
      composition: 'мука пш. 1 с., тыква запеченная, цельнозерновая мука, тыквенные семечки, мед, масло подсолн., морская соль, мука ржаная.'
    },
    {
      imgClass: 'bread-15',
      name: 'Безглютеновый хлеб',
      weight: '500 г.',
      composition: 'мука зеленой гречки, мука льнаная, лен, крахмал кукурузный, вода, морская соль.'
    },
    {
      imgClass: 'bread-16',
  ...
  pie: [
    {
      imgClass: 'pie-10',
      name: 'Пирог яблочно-банановый',
      weight: '1000 г.',
      composition: 'мука пш. 1 с., вода, молоко, яблоко, банан, солод, масло подсолн., тростниковый сахар, морская соль, корица.'
    },
    {
      imgClass: 'pie-9',
      name: 'Пирог шпинатный',
      weight: '1000 г.',
      composition: 'мука пш. 1 с., вода, молоко, шпинат, сыр фета, куриное яйцо, сыр выдержанный, солод, масло подсолн., тростниковый сахар, морская соль, чеснок, укроп.'
    },
    {
      imgClass: 'pie-1',
  ...
  baking: [
    {
      ...
      name: 'Шампиньоны',
      weight: '500 г.',
      composition: 'мука пш., сливочное масло, куриное яйцо, сахарная пудра, кукурузный крахмал, соль, ваниль, какао.'
    },
    {
      imgClass: 'bakery-20',
      name: 'Коврижка постная монастырская',
      weight: '450 г.',
      composition: 'мука пш., сахар, вода, масло подсолн., изюм, какао, корица, имбирь, соль.'
    },
    {
      imgClass: 'bakery-18',
      name: 'Винтажное печенье',
      weight: '240 г.',
      composition: 'мука пш., сливочное масло, куриное яйцо, ваниль, сахар, карамель.'
    },
    {
      imgClass: 'bakery-17',
      name: 'Лимонное печенье с маком',
      weight: '500 г.',
      composition: 'мука пш., сливочное масло, кукурузный крахмал, сахар, куриное яйцо, молоко, лимон, мак.'
    },
    {
      imgClass: 'bakery-16',
      name: 'Шоколадное печенье с глазурью',
      weight: '500 г.',
      composition: 'мука пш., молоко, сахар, какао, растительное масло, соль, куриное яйцо, сахарная пудра, сок лимона.'
    },
    {
      imgClass: 'bakery-15',
    ...
    {
      imgClass: 'puff_1',
      name: 'Слойка с чечевицей',
      weight: '110 г.',
      composition: 'слоеное тесто, куриное яйцо, зеленая чечевица, сыр фета, морковь, лук, соль морская.'
    },
    {
      imgClass: 'puff_1',
      name: 'Слойка с курицей',
      weight: '110 г.',
      composition: 'слоеное тесто, куриное яйцо, куриное филе, сыр выдержанный, молоко коровье, сливочное масло, мука пш. 1 с., соль морская, смесь перцев, мускатный орех, карри.'
    },
    {
      imgClass: 'puff_1',
      name: 'Слойка с ветчиной, сыром и соусом бешамель',
      weight: '110 г.',
      composition: 'слоеное тесто, куриное яйцо, ветчина, сыр выдержанный, молоко коровье, сливочное масло, мука пш. 1 с., соль морская, смесь перцев, мускатный орех.'
    },
    {
      imgClass: 'puff_1',
