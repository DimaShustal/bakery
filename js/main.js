const menuSections = {
  bread: [
    ...
    },
    {
      ...
      weight: '500 г.',
      composition: 'вода, мука пшеничная в/с, мука ржаная обдир., дробленая кукуруза, плющенные рож, семена (льна, подсолнечника, тыквы, кунжута), солод, морская соль, кориандр .'
    },
    {
      imgClass: 'bread-7',
      ...
      weight: '500 г.',
      composition: 'мука пш. в/с, мука ржаная, соль, грецкий орех, курага, вода.'
    },
    {
      imgClass: 'bread-8',
    ...
    },
    {
      ...
      description: '',
      weight: '500 г.',
      composition: 'мука пш. в/с, тыква, цельнозерновая мука, кужут, лен, мед, масло подсолн., морская соль, мука ржаная.'
    },
    {
      imgClass: 'bread-15',
    ...
    },
    {
      ...
      weight: '550 г.',
      composition: 'мука пш. в/с, мука ржаная, вода, картофель, чеснок, тимьян, розмарин, базилик, шалфей, морская соль.'
    },
    {
      imgClass: 'bread-21',
  ...
  baking: [
    {
      ...
      description: '',
      weight: '1000 г.',
      composition: 'мука пш. в/с, сливочное масло, куриное яйцо, молоко, сливки 35%, сахар тростниковый, соль морская, шоколад молочный или горький.'
    },
    {
      imgClass: 'bakery-2',
      name: 'Бискотти',
